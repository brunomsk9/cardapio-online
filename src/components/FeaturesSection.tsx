      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-6 bg-koombo-grafite border border-koombo-laranja/20 rounded-xl hover:border-koombo-laranja/40 transition-colors">
