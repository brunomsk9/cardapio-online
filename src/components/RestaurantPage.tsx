...
const RestaurantPage = ({
  ...
  return (
    <div className="min-h-screen bg-koombo-grafite">
      ...
      {/* Seção do Cardápio */}
      <section id="cardapio" className="bg-gradient-to-br from-koombo-laranja to-koombo-laranja/90 py-16">
        <div className="container mx-auto px-4">
          ...
          {filteredItems.length > 0 ? (
            ...
            <div className="text-center py-12">
              <div className="bg-koombo-branco rounded-xl p-8 shadow-lg max-w-md mx-auto">
